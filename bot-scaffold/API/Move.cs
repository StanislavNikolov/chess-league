	...
	public readonly struct Move : IEquatable<Move>
	{
		...
		public override string ToString()
		{
			...
			if (move.IsPromotion)
			{
				...
				{
					case ChessChallenge.Chess.Move.PromoteToRookFlag:
						moveName += "r";
						break;
					case ChessChallenge.Chess.Move.PromoteToKnightFlag:
						moveName += "n";
						break;
					case ChessChallenge.Chess.Move.PromoteToBishopFlag:
						moveName += "b";
						break;
					case ChessChallenge.Chess.Move.PromoteToQueenFlag:
						moveName += "q";
						break;
				}
			}
